...
This is the repository for the Golfin V4 website. Currently, It's using [Payload CMS](https://payloadcms.com/) as the frontend/backend architecture, and connecting to a [Supabase](https://supabase.com/)-hosted PostreSQL database.

In order to get started, you should have [Node.js](https://nodejs.org/en/download/package-manager) installed.
